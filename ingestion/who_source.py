...
from core.config import WHO_BASE_URL
from core.utils import get_logger
from ingestion.base_source import BaseSource

logger = get_logger(__name__)

# Page size for OData $top parameter (not in v2 config — defined here)
_WHO_PAGE_SIZE: int = 1000
# Polite delay between pages
_WHO_RATE_LIMIT_SECONDS: float = 0.5

# Maps WHO indicator codes → friendly names for get_metadata display.
# Users may also pass raw codes directly.
WHO_INDICATORS: dict[str, str] = {
    ...
    "SA_0000001462": "alcohol_consumption",
}

# Maps friendly names → WHO indicator codes
...
class WHOSource(BaseSource):
    ...
    def __init__(self) -> None:
        ...
        self._last_extract_time: str | None = None  # kept for backward compat; _record_extract sets last_extract_time
    ...
    def extract(
        ...
        while len(all_records) < max_records:
            ...
            params = {"$top": _WHO_PAGE_SIZE, "$skip": skip}
            ...
            skip += _WHO_PAGE_SIZE  # Move to the next page
            ...
            time.sleep(_WHO_RATE_LIMIT_SECONDS)
    ...
    def get_metadata(self) -> dict:
        ...
        meta["base_url"] = WHO_BASE_URL
        meta["available_indicators"] = list(WHO_INDICATORS.values())
        meta["last_indicator"] = self._last_indicator
        return meta
